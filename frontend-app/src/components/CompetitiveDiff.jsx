            ...
            <div key={index} className="bg-white rounded-xl shadow-lg p-6">
              <div className="flex items-start justify-between mb-4">
                ...
                <div className={`w-12 h-12 rounded-lg bg-${comp.color}-100 flex items-center justify-center`}>
                  <AlertCircle className={`w-6 h-6 text-${comp.color}-600`} />
                </div>
              </div>
                ...
                {features.map((row, index) => (
                  <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                    ...
                    <td className="px-6 py-4 text-center">
                      {row.vagaro ? <Check className="w-5 h-5 text-green-500 mx-auto" /> : <X className="w-5 h-5 text-red-500 mx-auto" />}
                    </td>
                    <td className="px-6 py-4 text-center">
                      {row.zenoti ? <Check className="w-5 h-5 text-green-500 mx-auto" /> : <X className="w-5 h-5 text-red-500 mx-auto" />}
                    </td>
                    <td className="px-6 py-4 text-center">
                      {row.boulevard ? <Check className="w-5 h-5 text-green-500 mx-auto" /> : <X className="w-5 h-5 text-red-500 mx-auto" />}
                    </td>
                    <td className="px-6 py-4 text-center">
                      {row.pabau ? <Check className="w-5 h-5 text-green-500 mx-auto" /> : <X className="w-5 h-5 text-red-500 mx-auto" />}
                    </td>
                    <td className="px-6 py-4 text-center bg-indigo-50">
                      {row.medspasync ? <Check className="w-5 h-5 text-indigo-600 mx-auto" /> : <X className="w-5 h-5 text-red-500 mx-auto" />}
                    </td>
                  </tr>
                ))}
              </tbody>
