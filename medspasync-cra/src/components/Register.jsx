  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded shadow">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <input type="text" placeholder="First Name" className="w-full p-2 border rounded" value={firstName} onChange={(e) => setFirstName(e.target.value)} />
        <input type="text" placeholder="Last Name" className="w-full p-2 border rounded" value={lastName} onChange={(e) => setLastName(e.target.value)} />
        ...
        <input type="text" placeholder="Practice ID (optional)" className="w-full p-2 border rounded" value={practiceId} onChange={(e) => setPracticeId(e.target.value)} />
