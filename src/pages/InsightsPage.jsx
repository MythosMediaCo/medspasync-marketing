      ...
      <section className="pt-24 pb-20 gradient-bg">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Link to="/insights/software-integration-failures" className="block bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg hover:shadow-xl transition duration-300">
            ...
            <Link to="/insights/hipaa-compliance" className="block bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg hover:shadow-xl transition duration-300">
